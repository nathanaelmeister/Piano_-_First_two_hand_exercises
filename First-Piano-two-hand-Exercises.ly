...
\book {
  ...
  \pageBreak
  \include "single-pages/12_Volkslied_-_Hänschen_klein.ly"
  \include "single-pages/13_Volkslied_-_Vogelhochzeit.ly"
  \include "single-pages/14_Volkslied_-_Kuckuck_kuckuck.ly"
  \include "single-pages/15_Volkslied_-_Summ_summ_summ.ly"
  \include "single-pages/17_Volkslied_-_Der_Kuckuck_und_der_Esel.ly"
  \pageBreak
